...
public abstract class DAO<D> {
    ...
    */
    public abstract D find(int id) throws DAO_Exception;
     ...
     * @throws DAOException en cas de probl�me
     */
    public abstract void create(D data) throws DAO_Exception;
     ...
     * @throws DAOException en cas de probl�me
     */
    public abstract void update(D data) throws DAO_Exception;
     ...
     * @throws DAOException en cas de probl�me
     */
    public abstract void delete(D data) throws DAO_Exception;
    
    /**
     * Construit le DAO pour la classe param�tr�e.
     * @throws DAOException en cas de probl�me
     */
    public DAO() throws DAO_Exception {
    }
}
