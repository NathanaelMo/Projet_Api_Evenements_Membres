...
public class DAO_JPA<D> extends DAO {
   ...
   */
  public DAO_JPA() throws DAO_Exception {
    try {
      ...
      throw new DAO_Exception("Problème technique (" + e.getMessage() + ")");
    }
  }
  ...
  @Override
  public Object find(int id) throws DAO_Exception {
  ...
  @Override
  public void create(Object data) throws DAO_Exception {
    this.em.persist(data);
  }

  @Override
  public void update(Object data) throws DAO_Exception {
    this.em.merge(data);
  }

  @Override
  public void delete(Object data) throws DAO_Exception {
    this.em.remove(data);
  }
}
